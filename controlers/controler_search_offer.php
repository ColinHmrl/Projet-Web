...
if(isset($_COOKIE['user'])) {
    ...
    $tab = ["cpilot" => (Requetes\Rights::haveRight(unserialize($_COOKIE['user'])->id,'Créer un compte pilote')),
        ...
        "doffer" => (Requetes\Rights::haveRight(unserialize($_COOKIE['user'])->id,'Supprimer une offre')),
        "moffer" => (Requetes\Rights::haveRight(unserialize($_COOKIE['user'])->id,'Modifier une offre')),
