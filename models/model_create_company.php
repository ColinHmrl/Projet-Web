...
function post_form($name,$description,$activity_area,$locality,$email){
    ...
    if($_POST){ 
        ...
        try {
            ...
            //$prepared->bindValue(':description', $description, PDO::PARAM_STR);
            //$prepared->bindValue(':locality',$locality, PDO::PARAM_STR);
            //$prepared->bindValue(':activity_area',$activity_area, PDO::PARAM_STR);
            //$prepared->bindValue(':email',$email, PDO::PARAM_STR);
            $prepared->execute(array('id'=>NULL,'name'=>'$name','activity_area'=>'$activity_area','locality'=>'$locality','email'=>'$email','invisible'=>0,'del'=>0,'description'=>'$description'));
        }
